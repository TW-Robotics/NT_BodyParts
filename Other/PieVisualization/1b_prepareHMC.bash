#!/bin/bash
#tar zxvf ./resdata.tgz #Untar Peters file
#cd ./resdata
...
do
    #--- GP-LVM ---#
	#--- top 14 ---#
    cp "./BGPLVM_NoReplace_14/rshfl_gpall_it""$i""__allardres.csv" "./BGPLVM_NoReplace_14/$i""_Relevance.csv"
    cp "./BGPLVM_replace_14/rsmp_gpall_it""$i""__allardres.csv"   "./BGPLVM_replace_14/$i""_Relevance.csv"
	#--- manual selected ---#
    cp "./BGPLVM_NoReplace/rshfl_gpred_it""$i""__allardres.csv" "./BGPLVM_NoReplace/$i""_Relevance.csv"
    cp "./BGPLVM_replace/rsmp_gpred_it""$i""__allardres.csv"   "./BGPLVM_replace/$i""_Relevance.csv"

    #--- Procrustes ---#
    cp "./Procrustes_NoReplace/rshfl_prc_it""$i""__allardres.csv" "./Procrustes_NoReplace/$i""_Relevance.csv"
